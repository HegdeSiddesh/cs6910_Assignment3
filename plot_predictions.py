...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 30 00:35:43 2022
...
words = [ ('aeathimuka','ஏதிருக்கம்','அஇஅதிமுக'), 
         ('sandhya'	,'சந்தியா','	சந்தியா'),
         ('samanana','	சமணான','	சமனான'),
         ('munmaadhiri','முன்னாதிரி','முன்மாதிரி'), ('moonrarai','மூன்றரை','மூன்றரை'),
         ('raajaraajanin','ராஜராஜனானின்','ராஜராஜனின்')]
...
with open('/home/hithesh/prediction_grid.html', 'w', encoding='utf-8') as f:
    f.write(html)